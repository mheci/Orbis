...
## What this repo is
Firefox containers MV3, TS:292k, esbuild+vitest+gitleaks/zizmor
...
| create-verification-skill | Generate project-local verification skill |
| maintain-verification-skill | Keep verification skill honest |
...
| typescript-best-practices | TS: branded, unknown>any, never exhaust |
| principle-minimize-reader-load | Collapse one-caller wrappers |
| principle-guard-the-context-window | Route bulk to subagents |
| no-comments | Delete narrating comments, encode constraints |
| technical-writing | Diataxis + Google style |
